        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            <div class="navbar-header">
                <a class="navbar-brand" href="/">
                    <b>
                        <img src="/images/logo-icon.png" alt="home" class="dark-logo" width="30" />
                        <img src="/images/logo-light-text.png" alt="home" class="light-logo" width="100" />
                    </b>
                    <span class="hidden-sm-down" style="display:none;">
                        <img src="/images/logo-text.png" alt="home" class="dark-logo" width="100"/>
                        <!--<img src="/images/logo-light-text.png" class="light-logo" alt="home" width="100" />-->
                    </span>
                </a>
            </div>
            <div class="navbar-collapse">
                <ul class="navbar-nav mr-auto mt-md-0 ">
                    ...
                    <li class="nav-item"> <a class="nav-link sidebartoggler hidden-sm-down text-muted waves-effect waves-dark" href="javascript:void(0)"><i class="icon-arrow-left-circle fa"></i></a> </li>
                </ul>
