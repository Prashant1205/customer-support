...
let routes = [
    {
        ...
        children: [
            ...
            {
                path: '/escalation',
                component: require('./views/escalation/index')
            },
            {
                path: '/escalation/:id/edit',
                component: require('./views/escalation/edit')
            },
            {
                path: '/home',
            ...
            {
                path: '/outbound',
                component: require('./views/outbound/index')
            },
            {
                path: '/user',
            ...
            {
                path: '/outboundlist',
                component: require('./views/outboundlist/index')
            },
            {
                path: '/inboundlist',
                component: require('./views/inboundlist/index')
            },
            {
                path: '/forms-list',
            ...
            {
                path: '/fos',
                component: require('./views/fos/index')
            }
]
    },
    {
