$(function () {
    ...
    var set = function () {
            ...
            if (width < 767) {
                ...
                $(".sidebartoggler i").addClass("fa-bars");
            }
            else {
                $("body").addClass("mini-sidebar");
                $('.navbar-brand span').hide();
                $(".sidebartoggler i").addClass("fa-bars");
                $(".sidebartoggler i").removeClass("fa-arrow-circle-o-left");
            }
    ...
    $(document).on('click','.sidebartoggler', function () {
        if ($("body").hasClass("mini-sidebar")) {
            ...
            $(".sidebartoggler i").addClass("fa-arrow-circle-o-left");
        }
        else {
            $("body").trigger("resize");
            $(".scroll-sidebar, .slimScrollDiv").css("overflow-x", "visible").parent().css("overflow", "visible");
    ...
    $(document).on('click', '.hide-menu', function () {
        if (window.innerWidth < 768 || $("body").hasClass("show-sidebar")) {
