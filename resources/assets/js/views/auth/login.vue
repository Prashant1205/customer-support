<template>
    <section id="wrapper">
        <div class="login-register">
            ...
            <div class="card-body">
                <div class="login-modal-logo text-center mb-5">
                    <img src="/images/logo-text.png" alt="home" class="dark-logo" width="150"/>
                </div>
                <form class="form-horizontal form-material" id="loginform" @submit.prevent="submit">
                    <!--<h3 class="box-title m-b-20">Sign In</h3>-->
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input type="email" name="email" class="form-control" placeholder="Email" v-model="loginForm.email" required> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="password" name="password" class="form-control" placeholder="Password" v-model="loginForm.password" required> </div>
                    </div>
