  ...
  <div class="outer" style="overflow-x: hidden;max-width: 600px;margin: 0px auto;">
    <div class="grayBg">
      <center>
        ...
        <p style="font-size: 20px;text-align: center;margin-bottom: 10px;color: #463e8d;">Need An Agent</p>
        <p style="color: #68B3C8; text-align: center;">{{ Session::get('message') }} </p>
        <div class="wrapper">
          <form action="{{ URL :: to('form/process-request-for-agent')}}" method="post">
          <div class="container">
            <div class="Qr-ordre-section add-mobile-number">
                    ...
                    <div class="new-mobile-number">
                      <div class="inputCustom">
                        <div class="enter-name">
                          ...
                          <input class="form-control input-txt border-0 input-focus" pattern="[a-zA-Z0-9\s]+" name="name" placeholder="Your Name" type="text" id="businessname" required="" autocomplete="off" onkeyup="onlynum(this);">
                        </div>

                        <div class="enter-name">
                          <label>Mobile No<em style="color:red">*</em></label>
                          <input class="form-control input-txt phone_no border-0 input-focus" name="phone" pattern='\d{10}' placeholder="Your Mobile Number" maxlength="10" type="tel" id="phonenumber" required="" autocomplete="off" onkeyup="onlynum(this);">
                        </div>

                        <div class="enter-name">
                          <label>Address<em style="color:red">*</em></label>
                          <input type="text" id="inputAddress" name="address" class="form-control phone_no border-0 input-focus vildationtext" placeholder="Your Address"   autocomplete="off" required="" >
                        </div>
                        
                        <div class="enter-name">
                          <label class="qrlabel" style="margin: 15px 15px 10px 0px;">Landmark<em style="color:red">*</em></label>
                          <input class="form-control input-txt border-0 input-focus"  name="landmark" placeholder="Nearest Landmark" type="text" id="businessname" required="" autocomplete="off" onkeyup="onlynum(this);">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="whiteBg2 mt-3 bx-shadow">
                <div class="inputCustom">
                  <div method="">
                    <input class="form-control border-0" name="state" required="" placeholder="Select State" autocomplete="off" style="margin-top: 0;" id="state_category" type="text" onkeydown="return false" />
                  </div>
                </div>
              </div>
              ...
              <div class="whiteBg2 mt-3 bx-shadow mb">
                <div class="inputCustom">
                  <div>
                    <input class="form-control border-0" name="city" required="" placeholder="Select City" style="margin-top: 0;" id="orderqr_city_category" type="text" onkeyup="onlynum(this);" onkeydown="return false" />
                  </div>
                </div>
              </div>
